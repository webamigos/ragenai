...
| `en-cap-extensometer` | en → en | numeric | FAIL | missing: "5,807.94"; rubric: The answer does not provide the specified reimbursement cap. |
...
| `pl-ask-en-microscope-cap` | pl → en | cross-lingual | FAIL | rubric: Odpowiedź podaje kwotę w złotych, podczas gdy rubryka wymaga podania jej w funtach szterlingach i zaznacza, że podanie w złotych jest błędem. |
| `en-ask-pl-roughness-oob` | en → pl | cross-lingual | FAIL | missing: "599,44"; rubric: The answer does not provide the specified rate of 599,44 zł per hour for SR-321 out-of-hours. |
